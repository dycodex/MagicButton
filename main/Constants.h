...
#define DEFAULT_DEVICE_ID           "mggez63kp6"//"Yggez63kp6"
#define DEFAULT_VENUE_ID            "andri559"//"marketing590"

#define DEFAULT_DEVICE_NAME         "My Magic Button"
#define DEFAULT_DEVICE_TYPES        "MagicButton"
#define DEFAULT_DEVICE_SUBTYPES     "Generic"

#define MQTT_SERVER                 "dypub.cloudapp.net" //"iot.eclipse.org"//"home-x.cloudapp.net"
