...
void initRB()
{
    rb = xRingbufferCreate(2048 * 10, RINGBUF_TYPE_NOSPLIT);
}

// void consumeI2SInput(void *p)
// {
//     char *buf;
//     size_t len;
...
//         //ets_printf("TSK r");
//         // xRingbufferPrintInfo(rb);
//         buf = (char*)xRingbufferReceive(rb, &len, 2000 / portTICK_PERIOD_MS);
//         if (buf == NULL)
//         {
...
//             // i2s_write_bytes(I2S_NUM_0, (const char*)buf, len, portMAX_DELAY);
//         }
