...
//    generic_i2c_master_init (I2C_NUM_0, 22, 21, 100000);
...
//by Andri
bool SparkFun_APDS9960::isInterrupted(gesture_irq_t interrupt) {
	uint8_t status;
	...
	if( !wireReadDataByte(APDS9960_STATUS, status) ) {
		return false;
	}
...
//	esp_err_t ret = generic_write_i2c_register (APDS9960_I2C_ADDR, reg, val);
//	if (ret == ESP_FAIL) {
//		return false;
//	}
...
//	uint8_t ret = generic_read_i2c_register(APDS9960_I2C_ADDR, reg);
//	val = ret;
//
//	return true;
}
...
//	return generic_read_i2c_register_multi(APDS9960_I2C_ADDR, reg, val, len);
