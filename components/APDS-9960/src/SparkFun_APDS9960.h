...
#define DEFAULT_LDRIVE          LED_DRIVE_50MA //LED_DRIVE_100MA
...
#define DEFAULT_GPENTH          60 //40 //40      // Threshold for entering gesture mode
#define DEFAULT_GEXTH           20 //20 //30      // Threshold for exiting gesture mode
#define DEFAULT_GCONF1          0x40    // 4 gesture events for int., 1 for exit
#define DEFAULT_GGAIN           GGAIN_2X //GGAIN_4X
#define DEFAULT_GLDRIVE         LED_DRIVE_100MA
#define DEFAULT_GWTIME          GWTIME_5_6MS //GWTIME_8_4MS //GWTIME_2_8MS
...
public:
    ...
    //by Andri
    bool isInterrupted( gesture_irq_t interrupt );
